module mo_evt {
    export class TouchEvent extends egret.evt.TouchEvent {
        ...
        //@override
        public static dispatchTouchEvent(target:egret.evt.IEventDispatcher,type:string,touchPointID:number = 0, stageX:number = 0, stageY:number = 0,
