        ...
        function emitJavaScript(jsFilePath, root) {
            ...
            function emitMemberAssignments(node, staticFlag) {
                ts.forEach(node.members, function (member) {
                    ...
                    if (member.kind === 119 /* Property */ &&
                        (member.flags & 128 /* Static */) === staticFlag &&
                        initializer && initializer.kind != 83) {
                        writeLine();
    ...
    function createCompilerHost(options, defaultLibUrl) {
        ...
        return {
            ...
            getDefaultLibFilename: function () {
                ...
                var filename = ts.combinePaths(ts.getDirectoryPath(ts.normalizePath(sys.getExecutingFilePath())), "../lib/core/typescript/lib.d.ts");
                return filename;
            },
            writeFile: writeFile,
